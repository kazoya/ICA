...
export const siteConfig = {
  ...
  nameEn: "ICA Group",
  brandLine: "ICA",
  productName: "تصور مبيعات كيماويات وعناية شخصية",
  parentAr: "الشركة الصناعية التجارية الزراعية",
  parentEn: "ICA Group",
  recipient: "مدير المبيعات",
  recipientRole: "شركة الإنتاج",
  country: "الأردن",
  city: "عمّان",
  cityDetailAr: "الأردن",
  since: 0,
  websiteUrl: "https://ica-jo.com/",
  defaultMapsUrl: "",
  defaultWhatsAppPhone: "962787363700",
  defaultWhatsAppPrefill: "السلام عليكم شركة الإنتاج بخصوص ",
  defaultEmails: ["tamer@ica-jo.com"] as const,
  phones: ["962787363700", "962786444111"] as const,
  salesPhone: "962787363700",
