...
const items = [
  { title: "جملة الإغلاق", text: "الموزّع يريد تشكيلة شامبو ومنظّف اليوم. المنصة ترتّب الطلب وأنت تعتمد السعر" },
  { title: "ما يدرَّب عليه المندوب", text: "يعيد الوعد كما هو: طلب موزّع عناية شخصية يُلتقط من واتساب ويُسعَّر باعتماد بشري ثم يحول الرسالة بطاقة." },
