...
export function DiscoveryForm() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <PageHeader title="تقييم اكتشاف شركة الإنتاج" description="أسئلة المصنع والمبيعات وقناة التشغيل. يُحفظ في هذا المتصفح فقط." demo={false} />
      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          {step === 2 ? (
            <>
              <Field label="هل توجد قناة «موزّعو العناية» اليوم؟" name="schoolChannel" register={form.register} />
