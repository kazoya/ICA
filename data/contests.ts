...
export const contestRules = [
  { title: "التسجيل", text: "التسجيل من واتساب المبيعات. تُفتح بطاقة موزّعو العناية." },
  ...
  { title: "البيع", text: "طلب موزّع عناية شخصية يُلتقط من واتساب ويُسعَّر باعتماد بشري" },
  { title: "الصدق", text: "الموقع عربي مختصر وأخبار هيئة عامة. الكتالوج التفصيلي غير ظاهر للزائر." },
];
